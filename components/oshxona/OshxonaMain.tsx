...
import { SotuvManager } from '../ombor/SotuvManager';

type OshxonaView = 'hub' | 'retseptlar' | 'tayyorlash' | 'tarix' | 'sotuv';
...
export const OshxonaMain: React.FC<OshxonaMainProps> = ({ globalFilter, userRole }) => {
  ...
  return (
    <div className="animate-in fade-in duration-700 space-y-8">
      ...
      {currentView === 'sotuv' && <SotuvManager globalFilter={globalFilter} filterType="Ovqat" />}
    </div>
  );
};
